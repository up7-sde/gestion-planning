...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sde`.`VueListeEnseignants` (`nom` INT, `prenom` INT, `Categorie` INT, `Titulaire` INT, `HeuresDues` INT, `HeuresAffectees` INT);
