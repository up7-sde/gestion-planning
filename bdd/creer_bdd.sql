...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sde`.`VueListeService` (`apogee` INT, `intitule` INT, `type` INT, `nbHeures` INT, `annee` INT, `idEnseignant` INT, `nom` INT, `prenom` INT, `formation` INT, `diplome` INT);
