...
BEGIN
	-- Déclarer variables
    DECLARE v_nbHDejaAffectee INT DEFAULT 0;
    DECLARE v_nbHTemp INT DEFAULT 0;
    DECLARE v_nbHCMTotal INT DEFAULT 0;
    -- Initialiser les variables
	CALL calculerNbHeureCMAffecte(UPPER(p_apogee), v_nbHDejaAffectee);
...
DELIMITER $$
USE `sde`$$
CREATE PROCEDURE `calculerNbHeureCMAffecte` (IN p_apogee VARCHAR(45), OUT nbHeures INT)
BEGIN
